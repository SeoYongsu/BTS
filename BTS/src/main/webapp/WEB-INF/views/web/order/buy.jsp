...
<body>
	<div class="container">
	  ...
	  <table class="table">
	    ...
	    <tbody>
	      <tr>
	        <td><img alt="img" src="${ORDER.biImg}" height="70"/>&nbsp;&nbsp;&nbsp; ${ORDER.biTitle}</td>
	        <td>${boOrdercount}</td>
	        <td>${ORDER.biPrice *boOrdercount}</td>
	      </tr>
	    </tbody>
	  </table>
	</div>
	...
	<!-- 배송정보 수정 -->
	<div class="container">
		<form action="${pageContext.request.contextPath}/order/guide.web" id="bFrm" method="post">		
		  <h4>배송 정보</h4>
		  <table class="table">
	      <tr>
	        <th>받으실 분</th>
	      ...
	      <tr>
	        ...
	        <td>
	        	...
	        	<input type="text" class="form-control" value="${USER.mPhone2}" style="width: 90px;float:left" id="mPhone2" name="mPhone2" placeholder="중간번호" 
	      ...
	      <tr>
	      	<td colspan="2">
	      		...
	      		<input type="hidden" name="boBook" value="${ORDER.biNo}"/>
	      		<input type="hidden" name="boOrdercount" value="${boOrdercount}"/>
	      		<input type="hidden" name="boPrice" value="${ORDER.biSalPrice *boOrdercount}"/>
