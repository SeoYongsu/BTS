...
<div class="container contact">
	<div class="row">
		...
		<div class="col-md-9" style="text-align: left;">
			<form method="POST" align="center" action="${pageContext.request.contextPath}/member/memberUpdate.web" style="text-align: left;">
				<div class="contact-form">
				
					<div class="form-group row">
					  <label class="control-label col-sm-3" for="mName" style="text-align: center; margin-top: 6px;">이름</label>
					  <div class="col-sm-9 row">          
						<input type="text" class="form-control" id="mName" name="mName" required="required" pattern="^[가-힣]+$" 
						value="${MEMBERDETAIL.mName }">
					  </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9 row"> 
				        	...
				        	pattern="^[0-9]{4}" autocomplete="off" value="${MEMBERDETAIL.mPhone2 }" >
				        	...
				        	pattern="^[0-9]{4}" autocomplete="off"  value="${MEMBERDETAIL.mPhone3 }">
				        </div>
		    		</div>
					...
					<div class="form-group row">
					  ...
					  <div class="col-sm-4  row" >
						...
						readonly="readonly" value="${MEMBERDETAIL.mAddr1 }">          
					  </div>
			    	...
			    	<div class="form-group row">
					  ...
					  <div class="col-sm-9 row">          
						...
						value="${MEMBERDETAIL.mBirth }"  readonly="readonly">
					  </div>
					</div>
					
					<div class="form-group row">
			    		<label class="control-label col-sm-3" for="mUse" style="text-align: center; margin-top: 6px;">사용여부:</label>
...
<%-- 
	...
	MEMBERDETAIL.mNo -> ${MEMBERDETAIL.mNo }
		<input type="hidden" name="mSido" id="mSido" value="${MEMBERDETAIL.mSido }"/>
		<input type="hidden" name="mNo" id="mNo" value="${MEMBERDETAIL.mNo }"/>
		...
		<div>
      	...
      	<div>
	        ...
	        <input style="width: 30px" type="text" id="mPhone1" name="mPhone1" maxlength="3" pattern="^[0-9]{3}$" 
	        placeholder="앞번호" required="required" autocomplete="off"
	        value="${MEMBERDETAIL.mPhone1 }" >-
	        <input style="width: 40px" type="text" id="mPhone2" name="mPhone2" maxlength="4" pattern="^[0-9]{4}$" 
	        placeholder="중간번호" required="required" autocomplete="off"
	        value="${MEMBERDETAIL.mPhone2 }" >-
	        <input style="width: 40px" type="text" id="mPhone3" name="mPhone3" maxlength="4" pattern="^[0-9]{4}$" 
	        placeholder="뒷번호" required="required" autocomplete="off"
	        value="${MEMBERDETAIL.mPhone3 }" >
    	</div>
    	...
    	<div>
        	...
        	<input type="text" style="width: 120px" class="form-control" id="mBirth" name="mBirth" 
    	...
    	<div>
      		<label for="mBirthyy">생년월일:</label>
        	<input type="text" style="width: 90px" class="form-control" id="mBirthyy" name="mBirthyy" 
        	placeholder="년(4자)" maxlength="4" required="required"
        	pattern="[0-9]{4}" autocomplete="off" 
        	value="${MEMBERDETAIL.mBirthyy}">
        	
	  		<select id="mBirthmm" name="mBirthmm" required="required"
	  		value="${MEMBERDETAIL.mBirthmm}">
        	...
        	<input type="text" style="width: 90px" id="mBirthdd" name="mBirthdd" placeholder="일" maxlength="2" required="required" 
        	pattern="^[1-9]{1}$|^[1-2]{1}[0-9]{1}$|^30|^31$" autocomplete="off" 
        	value="${MEMBERDETAIL.mBirthdd}">
    	</div>
    	
    	
    	<div>
    		<label for="mUse">사용여부:</label>
    		<select id="mUse" name="mUse" required="required">
    		<option value="Y">Y</option>
    		<option value="N">N</option>
    		</select>
